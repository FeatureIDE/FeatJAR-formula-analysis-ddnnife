 ...
 */
public class ComputeSolutionsDdnnife extends ADdnnifeAnalysis<BooleanAssignmentList> {

    public static final Dependency<Integer> SOLUTION_COUNT = Dependency.newDependency(Integer.class);

    public ComputeSolutionsDdnnife(IComputation<DdnnifeWrapper> ddnnifeWrapper) {
        super(ddnnifeWrapper, Computations.of(1));
    }

    protected ComputeSolutionsDdnnife(ComputeSolutionsDdnnife other) {
        super(other);
    }
