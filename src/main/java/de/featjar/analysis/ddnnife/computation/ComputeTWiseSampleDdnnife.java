 ...
 */
public class ComputeTWiseSampleDdnnife extends ADdnnifeAnalysis<BooleanAssignmentList> {

    public static final Dependency<Integer> T = Dependency.newDependency(Integer.class);
    public static final Dependency<Long> RANDOM_SEED = Dependency.newDependency(Long.class);

    public ComputeTWiseSampleDdnnife(IComputation<DdnnifeWrapper> ddnnifeWrapper) {
        super(ddnnifeWrapper, Computations.of(2), Computations.of(1L));
    }

    protected ComputeTWiseSampleDdnnife(ComputeTWiseSampleDdnnife other) {
        super(other);
    }
